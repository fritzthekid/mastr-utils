...
class Analyse(object):
    ...
    def run_analysis(self, capaciy_list=[5000, 10000, 20000], power_list=[2500,5000,10000]):
        """Run the analysis"""
    ...
    def visualise(self, start=0, end=None):
        ...
        ax2.set_ylabel("[kWh]")
        ax2.grid(True)
        ax3.plot(self.data.index[start:end], self.data["battery"][start:end], color = "blue")
        # ax3.legend(["battery"])
